...
def draw_lines():
  ...
  pygame.draw.line(screen,BLACK,(0,600),(600,600),LINE_WIDTH)
  #vertical - lines
...
def draw_vertical_winning_line(col,player):
  pygame.draw.line(screen,RED,(col*200+100,0),(col*200+100,595),20)
...
def draw_figures():
  for row in range(BOARD_ROWS):
    for col in range(BOARD_COLUMNS):
      if board[row][col]==1:
        pygame.draw.circle(screen,(0,0,250), (int ((col*200)+100),int((row*200)+100)),CIRCLE_RADIUS,CIRCLE_WIDTH)
      elif board[row][col]==2:
        pygame.draw.line(screen,(40,60,120),(col*200+SPACE,(row*200+200)-SPACE),((col*200+200)-SPACE,(row*200)+SPACE),15)
        pygame.draw.line(screen,(40,60,120),(col*200+SPACE,(row*200)+SPACE),((col*200+200)-SPACE,(row*200+200)-SPACE),15)
...
resetButton = button(40,615,'Reset')
resetButton.draw_button()

text1 = font.render('O WON', True, black)
text2 = font.render('X WON', True, black)
